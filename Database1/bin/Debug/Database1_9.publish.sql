...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [CK__User__Phone__7C4F7684];
...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [CK__User__Pincode__7D439ABD];
...
GO
ALTER TABLE [dbo].[User] ALTER COLUMN [DOBDate] NVARCHAR (20) NOT NULL;

ALTER TABLE [dbo].[User] ALTER COLUMN [DOBTime] NVARCHAR (20) NOT NULL;
