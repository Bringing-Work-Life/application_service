...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [CK__User__Phone__7E37BEF6];
...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [CK__User__Pincode__7F2BE32F];
...
GO
ALTER TABLE [dbo].[User] ALTER COLUMN [Phone] NVARCHAR (20) NOT NULL;

ALTER TABLE [dbo].[User] ALTER COLUMN [Pincode] NVARCHAR (20) NOT NULL;
