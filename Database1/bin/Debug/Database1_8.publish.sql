...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [DF__User__Id__6FE99F9F];
...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [CK__User__Phone__76969D2E];
...
GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [CK__User__Picode__778AC167];
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[User])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_User] ([Id], [FirstName], [MiddleName], [LastName], [DOBDate], [DOBTime], [Phone], [Street1], [Street2], [City], [State], [UserName], [Password])
        SELECT   [Id],
                 [FirstName],
                 [MiddleName],
                 [LastName],
...
GO
ALTER TABLE [dbo].[User] WITH NOCHECK
    ADD CHECK ([Pincode] BETWEEN 0 AND 9999999);
