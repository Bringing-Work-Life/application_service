...
GO
PRINT N'Altering Table [dbo].[Samples]...';


GO
ALTER TABLE [dbo].[Samples] ALTER COLUMN [Description] NVARCHAR (MAX) NULL;


GO
PRINT N'Creating Procedure [dbo].[spCreateSample]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[spDeleteSample]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[spReadSample]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[spUpdateSample]...';
